...
function protactedTemplate($page) {
    ...
    $whiteListDomains = array('www.loginradius.com','docs.loginradius.com','docs.loginradius.org', 'apidocs-prod.us-east-1.elasticbeanstalk.com', 'lr-apidocs.azurewebsites.net','apidocs.loginradius.com','support.loginradius.com');
    if (!empty($tempHost)) {
