...
echo "<atom:link href='https://www.loginradius.com/legacy/docs/api/changelog/feed/' rel='self' type='application/rss+xml'/>\n";
echo "<description>New enhancements and releases</description>\n";
echo "<link>https://www.loginradius.com/legacy/docs/api/changelog</link>\n";
...
foreach ($filelist as $filename)
{
    ...
    echo "<link>https://www.loginradius.com/legacy/docs/api/changelog/$filename</link>\n";
    echo "<atom:link href='https://www.loginradius.com/legacy/docs/api/changelog/$filename' rel='self' type='application/rss+xml'/>\n";
    echo "</item>\n";
