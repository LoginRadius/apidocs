var LoginRadiusSDK = (function () {
    ...
    /**
     * The User Profile API is used to get social profile data from the user’s social account after authentication. The social profile will be retrieved via oAuth and OpenID Connect protocols. The data is normalized into LoginRadius' standard data format.
     *
     * @function
     * @public
