...
|  AddEmail   |      [Auth Verify Email by OTP](/api/v2/customer-identity-api/authentication/auth-verify-email-by-otp) <br />             [Auth Verify Email](/api/v2/customer-identity-api/authentication/auth-verify-email) _*This API will trigger the AddEmail webhook only in the case of verifying the additional email addresses._<br> |
...
|  DeleteAccount  |  [Account Delete](/api/v2/customer-identity-api/account/account-delete)<br>[Account Delete by Email](/api/v2/customer-identity-api/account/account-delete-by-email)<br> [Auth Account Delete](/api/v2/customer-identity-api/authentication/auth-delete-account)|
...
|  LinkAccount  |                 [Smart Login Ping](/api/v2/customer-identity-api/smart-login/smart-login-ping)<br> [Auth Account Delete](/api/v2/customer-identity-api/authentication/auth-delete-account)[Auth Social Identity](/api/v2/customer-identity-api/authentication/auth-social-identity)<br> [Auth Link Social Identities](/api/v2/customer-identity-api/authentication/auth-link-social-identities)|
...
1. Go to Integrations >Data Sync > Web Hooks in the LoginRadius Admin Console.
 ![Webhook](https://apidocs.lrcontent.com/images/15_1487162041c413c22a4.27950401.png "Webhook")

1. Click **+Add** button and enter the available webhook name,webhook events in loginRadius and URL where payload data will be sent when the webhook events is triggered.

 ![Webhook](https://apidocs.lrcontent.com/images/webhook_1765662f20983e59f78.37240472.png "Webhook")

 > **Note:** Validation rule for webhook name are as follow: maximum length allowed is of **24 words**, number, character, special character (underscore, hyphen, space ) allowed. If you violate these rules, error will appear.

1. Successfully configured webhook will be displayed in the Web Hooks section.!![enter image description here](https://apidocs.lrcontent.com/images/Webhook3_310985eb66a3769f521.42965339.png "enter image title here")



**Removing a webhook event**

1. Click Unsubscribe to remove an webhooks event from LoginRadius.![enter image description here](https://apidocs.lrcontent.com/images/webhook4_240855eb66b5d8d4e84.82392147.png "enter image title here")
...
> **Note:** Any changes made in the webhook section, like **new webhook** add or **delete the existing webhook**, will be visible in the **[Team Management Audit Log section](https://adminconsole.loginradius.com/account/team/audit-logs)**. For more details regarding **Audit Log** please refer [**here**](/api/v2/admin-console/team-management/audit-logs/#audit-logs).