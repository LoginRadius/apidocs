...
Upon clicking it, it'll redirect you to a page where you can export the API calls to Postman.  The API calls are divided in their respective sections.


## How to Import

1. Simply go to an API call link (such as [here](/api/v2/cloud-directory/get-user-identity))
