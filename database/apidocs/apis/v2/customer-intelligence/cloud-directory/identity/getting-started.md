...
**NOTE:** This API does not support querying Custom Objects, please refer to our [Custom Object API](/api/v2/cloud-directory/custom-object-overview) to query custom objects
