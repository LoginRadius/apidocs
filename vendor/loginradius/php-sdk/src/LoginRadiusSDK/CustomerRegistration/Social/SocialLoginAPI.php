...
class SocialLoginAPI
{
    ...
    /**
     * LoginRadius function - To fetch social profile data from the user's social account after authentication. The social profile will be retrieved via oAuth and OpenID Connect protocols. The data is normalized into LoginRadius' standard data format.
     *
    ...
    /**
     * LoginRadius function - To fetch custom fileds of raas. The social profile will be retrieved via oAuth and OpenID Connect protocols. The data is normalized into LoginRadius' standard data format.
     *
